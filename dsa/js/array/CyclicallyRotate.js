...
const rotateArray = (arr, arrayLength, k) => {
    ...
    reverseHalfArray(0, arrayLength - k - 1, arr) // [3, 2, 1, 4, 5, 6]
    reverseHalfArray(arrayLength - k, arrayLength - 1, arr) // [3, 2, 1, 6, 5, 4]
    console.log(arrayLength - k, arrayLength - 1, arr);
    return reverseHalfArray(0, arrayLength - 1, arr) // [3, 2, 1, 6, 5, 4]
}
